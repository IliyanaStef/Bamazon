...
// Prompts the manager for an action
function prompt() {
	inq.prompt(
		{
			name: "managerMenu",
...
// Makes a sql query to display all products to the manager
function showItems() {
...
// Prompts the manager to view the menu
function menu() {
	inq.prompt(
		{
			name: "menu",
...
// Makes a sql query to display low inventory items to the manager
function lowInv() {
...
// Adds additional inventory to the database
function addInv() {
	var selected;
...
// Makes a sql query to add a new product to the database
function newProduct() {
	inq.prompt([
		{
			name: "name",
